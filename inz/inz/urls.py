...
urlpatterns = [
    ...
    path('students/post/', views.StudentPostListView.as_view(), name='student_post_list'),
    ...
    path('teachers/post/', views.TeacherPostListView.as_view(), name='post_list'),
    path('teachers/post/detail/<int:pk>', views.PostDetailView.as_view(), name='post_detail'),
    path('teachers/post/add/', views.PostCreateView.as_view(), name='post_add'),
